      ...
      >
        <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-stone-100 border-2 border-primary-500/80">
            ...
            <div className="flex items-center justify-between">
              <Link href="/">
                <a className="w-24 sm:w-40 pt-1 md:mx-auto">
                  <Image src={DesktopLogo} alt="Marianna's Fundraisers Logo" />
                </a>
              </Link>
          ...
          <div className="py-6 px-5 md:max-w-lg md:mx-auto">
              ...
              {mobileSecondaryMenu.map((item, i) => {
                return (
                  <Link key={i} href={item.href}>
                    <a className="text-base font-medium text-stone-900 hover:text-stone-700 leading-5">
                      {item.name}
                    </a>
                  </Link>
                )
            ...
            {/* EXTRA ITEMS BUTTONS  */}
            <div className="mt-6 space-y-4 md:space-y-0 space-x-4">
