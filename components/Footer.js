...
const navigation = {
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/MariannasFundraisers",
      icon: props => (
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/channel/UCLpRCvfCBybdYsCyOGbU-bw",
      icon: props => (
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-stone-300 text-base font-medium">
              Marianna's Fundraisers is a part of the{" "}
              <a
